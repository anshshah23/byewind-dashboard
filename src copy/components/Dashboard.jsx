	...
	return (
		<>
			...
			>
				...
				>
					<div
						className={`w-[70%] rounded-3xl pt-8 pb-12 px-8 ${isDarkMode
								? "bg-zinc-800 hover:bg-zinc-700 text-white fade-in"
					...
					>
						...
						<ResponsiveContainer
							width="100%"
							height="100%"
							className={`${isDarkMode ? "text-white fade-in" : "text-black fade-out"
								}`}
						>
							<LineChart data={data}>
								<CartesianGrid strokeDasharray="3 3" />
					...
					<div
						className={`w-[30%] h-full rounded-3xl py-6 px-4 ${isDarkMode
								? "bg-zinc-800 hover:bg-zinc-700 text-white fade-in"
								: "bg-zinc-100 hover:bg-zinc-200 text-zinc-900 fade-out"
							}`}
					>
						...
						>
							{revenueDataCountry.map((data, index) => (
								<div key={index} className="mb-1">
									...
									<div
										className={`w-full h-2 ${isDarkMode ? "bg-zinc-700" : "bg-gray-200"
											} rounded-full mx-auto`}
									>
										<div
											className={`h-2 ${isDarkMode ? "bg-blue-500" : "bg-blue-500"
												} rounded-full`}
											style={{
