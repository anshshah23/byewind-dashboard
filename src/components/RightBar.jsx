...
export default function RightBar() {
	...
	return (
		<motion.div
			...
			className={`fixed right-0 top-0 h-full w-64 bg-white dark:bg-gray-800 shadow-lg transition-all duration-300 ${isRightClose ? "pointer-events-none" : "pointer-events-auto"
				}`}
		>
			<div className="p-4">
...
const Section = ({ title, children, isDarkMode }) => (
	<div>
		<h2
			className={`font-bold text-md mb-2 ${isDarkMode ? "text-zinc-100" : "text-zinc-900"
				}`}
		>
			{title}
		</h2>
