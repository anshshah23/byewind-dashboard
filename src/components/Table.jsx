...
const Table = () => {
	...
	return (
		<motion.div
			...
			className={`p-4 sm:p-6 w-full min-h-screen ${isDarkMode
		...
		>
			...
			<div
				className={`flex flex-wrap items-center justify-between mb-4 rounded-md p-2 ${isDarkMode
					? "bg-zinc-900 text-white fade-in"
			...
			>
				...
				<div className="relative mt-2 sm:mt-0">
					<FaSearch
						className={`absolute top-3 left-2 hover:text-yellow-300 ${isDarkMode ? "text-zinc-300 fade-in" : "text-zinc-400 fade-out"
							}`}
					/>
					<input
						type="text"
			...
			<div className="flex justify-center sm:justify-end mt-4">
				<ReactPaginate
					...
					pageClassName={`p-2 font-bold mx-1 sm:mx-2 rounded cursor-pointer ${isDarkMode ? "hover:bg-zinc-800 text-zinc-100 duration-100" : "hover:bg-zinc-200 text-zinc-900 duration-100"}`}
