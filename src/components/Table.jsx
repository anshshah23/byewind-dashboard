...
const Table = () => {
    ...
    const data = [
        ...
        { orderId: '#CM9806', user: 'Kane Diggory', project: 'Landing Page', address: 'Meadow Lane Oakland', date: 'Just now', status: 'In Progress' },
        { orderId: '#CM9807', user: 'Jane Greggory', project: 'CRM Admin pages', address: 'Larry San Francisco', date: 'A minute ago', status: 'Complete' },
        { orderId: '#CM9808', user: 'Mine Cano', project: 'Client Project', address: 'Bagwell Avenue Ocala', date: '1 hour ago', status: 'Pending' },
